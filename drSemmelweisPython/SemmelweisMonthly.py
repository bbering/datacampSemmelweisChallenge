...
before_washing.plot(x='date', y='proportion_deaths', label='Monthly death percentage before washing', ax=ax, legend=True)
after_washing.plot(x='date', y='proportion_deaths', label='Monthly death percentage after washing', ax=ax, legend=True)
